...
const PostDetails = () => {
  return (
    <div>
                ...
                <div className="flex items-center justify-between mt-2 md:mt-4">
                    ...
                    <div className="flex space-x-2">
                     ...
                     <div className="flex flex-col mt-4">
                      <h3 className="mt-6 mn-4 font-semibold">Comments</h3>
                      {/* comment */}
                      <div className="px-2 py-2 bg-gray-200 rounded-lg my-2">
                        <div className="flex items-center justify-between">
                          <h3 className="font-bold text-gray-600">@woodpeckers</h3>
                          <div className="flex justufy-center items-center space-x-4">
        ...
        {/* write a comment */}
        <div className="w-flex flec-col mt-4 md:flex-row">
